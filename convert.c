...
/* $Id: convert.c,v 1.5 2000-10-17 04:07:05 megastep Exp $ */
...
int convert_uninstall(const char *path, const char *name, const char *vername, const char *uninstall)
{
    ...
    if ( script ) {
        ...
        product = loki_create_product(name, root, NULL, url);
        if ( product ) {
...
int main(int argc, char **argv)
{
    ...
    if ( check_uninstall(argv[1]) ) { 
        ...
        return convert_uninstall(argv[1], argv[2], argv[3], uninst);
    } else {
